...
\begin{parts}
    ...
    \begin{enumerate}[label=\roman*.]
        ...
        \newline \ifans{
            $ \dfrac{\partial h_i}{\partial x_j} = \dfrac{\partial ReLU(x_i W + b_1)}{\partial x_j} = W $
        }
        ...
        \newline \ifans{
            \newline $ \dfrac{CE(y, \hat{y})}{\partial l_i} = \sum_j \dfrac{\partial CE(y, \hat{y})}{\partial \hat{y}_j} \dfrac{\partial \hat{y}_j}{\partial l_i}$
