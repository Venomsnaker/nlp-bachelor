    ...
    \part[4] Adam Optimizer\newline
        ...
        \begin{subparts}
            ...
            \subpart[2]First, Adam uses a trick called {\it momentum} by keeping track of $\bm$, a rolling average of the gradients:
                ...
                \ifans{
                    \newline The momentum m (controlled by parameter \( \beta_1 \)) acts as an average that smooths the update rate. It helps points the gradients toward the long-term minima, avoiding local minima and addressing noisy oscillations.
                }   
            ...
            \subpart[2] Adam extends the idea of {\it momentum} with the trick of {\it adaptive learning rates} by keeping track of  $\bv$, a rolling average of the magnitudes of the gradients:
                ...
                \ifans{
                    \newline Adam normalizes each parameter update (reducing high gradients, increasing low gradients) via elementwise multiplication. This keeps the learning rate consistent and increases convergence speed. 
                }
