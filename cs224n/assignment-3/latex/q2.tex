...
\begin{parts}
    ...
    \textcolor{Red} {
        \newline This allows the model to capture local dependencies and patterns among the character sequences.
        Each character (in Chinese) is either a word or a morpheme in a word, so the convolutional layer can identify the information around the word to predict it.
        Using a convolutional layer like this will help with predicting words unseen previously in the dictionary.
    }
    ...
    \begin{subparts}
        ...
        \textcolor{Red} {The model mistranslates the singular vs plural form. Make sure the number of singular and plural nouns in the training data are balanced.}
        ...
        \textcolor{Red} {The model duplicates the phrase "the resources have been exhausted". Adjust the mechanism to better fit the grammar.}
        ...
        \textcolor{Red} {The model mistranslates because it doesn't fully understand Chinese-oriented terms. Include more words and phrases that are unique to the Chinese language.}
        ...
        \textcolor{Red} {The model misses half of the meaning of the original Chinese idiom. Include special grammar structures (such as idioms) in the training dataset.}
    \end{subparts}
    ...
    \begin{subparts}
        ...
        \textcolor{Red} {
            For c1: $ p_1 = 4/9 - p_2 = 3/8 $
            \newline $ len(c1) = 9 - len(r2) = 6 \quad (len(r2) < len(r1))$
            \newline $ BP = 1 $
            \newline $ BLUE = 0.408 $
            \newline For c2: $ p_1 = 1 - p_2 = 3/5 $
            \newline $ len(c2) = 6 - len(r2) = 6 $
            \newline $ BP = 1 $
            \newline $ BLUE = 0.775 $
            \newline c2 is the better translation according to BLEU score, but I dissagre due to wrongful grammar.}

            \subpart[5] Our hard drive was corrupted and we lost Reference Translation $\br_1$. Please recompute BLEU scores for $\bc_1$ and $\bc_2$, this time with respect to $\br_2$ only. Which of the two NMT translations now receives the higher BLEU score? Do you agree that it is the better translation?
        
        \textcolor{Red} {
            For c1: $ p_1 = 4/9 - p_2 = 3/8 $
            \newline $ len(c1) = 9 - len(r2) = 6 $
            \newline $ BP = 1 $
            \newline $ BLUE = 0.408 $
            \newline For c2: $ p_1 = 1/2 - p_2 = 1/5 $
            \newline $ len(c2) = 6 - len(r2) = 6 $
            \newline $ BP = 1 $
            \newline $ BLUE = 0.316 $
            \newline c1 is the better translation according to BLEU score, I agree.}
        \subpart[2] Due to data availability, NMT systems are often evaluated with respect to only a single reference translation. Please explain (in a few sentences) why this may be problematic. In your explanation, discuss how the BLEU score metric assesses the quality of NMT translations when there are multiple reference transitions versus a single reference translation.
        
        \textcolor{Red} {
            A single translation for reference will not be able to fully capture the original sentence, thus making the evaluation wrongful.
            However, with more references, the score will take into account the variability and diversity of the target language and reduce bias.
        }
        
        \subpart[2] List two advantages and two disadvantages of BLEU, compared to human evaluation, as an evaluation metric for Machine Translation. 

        \textcolor{Red} {
            BLEU provides an objective and "calculatable" measure for translation grading while being scalable for large sentences.
            Meanwhile, it does not capture fluency, coherence, or expression of the original data and can assign high scores to unfaithful translations. 
        }
