...
\end{lstlisting}
    ...
    This is done by setting the values of $e_t$ corresponding to those elements to -inf. 
...
\end{lstlisting}
    ...
    \textcolor{Red} {
        ...
        \newline Additive Attention: learn weights for different set of weights but is more expensive to use.
    }
\end{parts}
