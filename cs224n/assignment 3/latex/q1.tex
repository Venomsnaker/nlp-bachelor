...
\end{lstlisting}
    ...
    \end{subparts}
    \textcolor{Red} {
        Dot Product Attention: more computational efficient but does not allow learning from multiple weights (limit in capturing patterns).
        \newline Additive Attention: learn weights for different set of weights but is more expensive to compute.
    }
\end{parts}
