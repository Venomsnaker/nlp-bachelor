...
\begin{parts}
    ...
    \textcolor{Red} {
        ...
        Using a convolutional layer like this will help with predicting word unseen previously in the dictionary.
    }
    ...
    \begin{subparts}
        ...
        \textcolor{Red} {The model mistranslates singular vs plural form. Make sure the number of singular and plural nouns in the training data are balanced.}
        ...
        \textcolor{Red} {The model duplicates the phrase "the resources have been exhausted". Adjust the mechanism to better fir the grammar.}
        ...
        \textcolor{Red} {The model misses half of the meaning of the original Chinese idiom. Include special grammar structures (such as idioms) in the train dataset.}
    \end{subparts}
    ...
    \begin{subparts}
        ...
        \textcolor{Red} {
            A single translation for reference will not be able to fully capture the original sentence, thus making evaluation wrongful.
            But with more references, the score will take into account the variability and diversity of the target language and reduce bias.
        }
        
        \subpart[2] List two advantages and two disadvantages of BLEU, compared to human evaluation, as an evaluation metric for Machine Translation. 

        \textcolor{Red} {
            BLEU provide an objective and "calculatable" measure for translation grading while being scalable for large sentences.
            Meanwhiles, it does not capture fluency, coherence, or expression of the original data and can assign high score to unfaithful translations. 
        }
