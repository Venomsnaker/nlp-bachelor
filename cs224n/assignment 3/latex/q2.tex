...
\begin{parts}
    ...
    ANSWERS: This allow the model to capture local dependencies and patterns among the character sequences. Each character is either a word or a morpheme in a word, so the convolutional layer could learn the patterns and predict new words.
    ...
    \begin{subparts}
        ...
        ANSWERS: The model misstranslates singular vs plural form. Increase the vartiety between singular and plural nouns in the training data.
        ...
        ANSWERS: The model misses the meaning of "space". Adjust the attention mechanism to better fit the language.
        ...
        ANSWERS: The model misstranslates because it doesn't fully capture the culture specific terms. Adjust the training data for more diverse culture aspects.
        ...
        ANSWERS: The model misss half of the meaning of the original sentence due to its being a Chinese idioms. Increase the training dataset for grammar structure in the original language. 
    \end{subparts}
    ...
    \begin{subparts}
        ...
        ANSWERS: BLEU c1 = 0.408; BLEU c2 = 0.632 - c2 is the better translation according to BLEU score, but I dissagre due to wrongful grammar.
        
        
        \subpart[5] Our hard drive was corrupted and we lost Reference Translation $\br_1$. Please recompute BLEU scores for $\bc_1$ and $\bc_2$, this time with respect to $\br_2$ only. Which of the two NMT translations now receives the higher BLEU score? Do you agree that it is the better translation?
        
        ANSWERS: BLEU c1 = 0.408; BLEU c2 = 0.316 - c1 is the better translation.
        
        \subpart[2] Due to data availability, NMT systems are often evaluated with respect to only a single reference translation. Please explain (in a few sentences) why this may be problematic. In your explanation, discuss how the BLEU score metric assesses the quality of NMT translations when there are multiple reference transitions versus a single reference translation.
        
        ANSWERS: A single translation for reference will not be able to capture multiple aspects of the original sentence, thus making evaluation wrongful. But with more references, the score will take into account the variability and diversity of the target language and reduce bias.
        
        \subpart[2] List two advantages and two disadvantages of BLEU, compared to human evaluation, as an evaluation metric for Machine Translation. 
        
        ANSWERS: BLEU provide an objective and "calculatable" measure for translation grading while being scalable for large sentences. Meanwhiles, it does not capture fluency, coherence, or expression of the original data and can assign high score to unfaithful translations. 
